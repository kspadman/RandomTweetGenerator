...
public class MarkovChain implements Iterator<String> {
    ...
    public boolean hasNext() {
        return (currentWord != null && currentWord != ""); // Complete this method.
    }
    ...
    public String next() {
        ...
        if (chain.get(currentWord) != null) {
            String next = chain.get(currentWord).pick(ng);
            currentWord = next;
        } else {
            currentWord = null;
        }
